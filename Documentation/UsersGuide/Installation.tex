RGG installers can be obtained from \todo{Get URL for where installers are to be hosted.} for all three major operating systems: Windows, Mac OS X, and Linux.  Detailed installation guides are detailed below by platform.
