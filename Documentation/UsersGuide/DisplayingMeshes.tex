...
To control viewing the mesh, be sure to click on the \ui{mesh tab} of the \ui{inputs panel}.  RGG allows you to six different options to control the \ui{3D view} of the mesh, listed below:
...
More detail on these views is provided below.  Additionally, you can check the \ui{show edges checkbox} to view the mesh superimposed on the 3D view and check the \ui{color checkbox} to colorize the different pieces of the view based on the option you've selected.
