...
% this format e.g. \ui{Properties} panel, \ui{Pipeline Browser}.  If 2nd option
% is provided, put that in the index instead.
%-------------------------------------------------------------------------------
\DeclareDocumentCommand \ui {m o}
{%
  \IfNoValueTF{#2}%
    {\texttt{#1}\index{ui}{#1}}%
    {\texttt{#1}\index{ui}{#2}}%
...
%-------------------------------------------------------------------------------
\newcommand{\toIndex}[1]{\index{keyword}{#1}}
